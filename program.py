...
def preprocess(is_train=False):
    ...
    # ptath='/media/ex/HDD/PaddleOCR-release-2.1/configs/rec/ch_ppocr_v2.0/rec_chinese_lite_train_slim_v3.0.yml'
    ptath='/media/ex/HDD/PaddleOCR-release-2.1/configs/rec/ch_ppocr_v2.0/rec_chinese_lite_train_v2.0.yml'
    # ptath='/media/ex/HDD/PaddleOCR-release-2.1/configs/rec/rec_mv3_none_bilstm_ctc1.yml'
    # ptath = '/media/ex/HDD/PaddleOCR-release-2.1/configs/rec/rec_r18_vd_none_bilstm_ctc.yml'
    config = load_config(ptath)
